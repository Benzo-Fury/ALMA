  ...
  execute: async (ctx, args) => {
    ...
    try {
      ...
      ctx.interaction.editReply({ content: response.data.data[0].url });
        ...
        ctx.interaction.editReply('A error occurred while trying to generate your image. Chances are that your prompt was inappropriate. Try again or use a different prompt.')
    }
  },
});
